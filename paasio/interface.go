...
func ReadCount() (int64, int) {
	return 0, 0
}

func WriteCount() (int64, int) {
	return 0, 0
}

func NewWriteCounter(io.Writer) WriteCounter {
	return nil
}

func NewReadCounter(io.Reader) ReadCounter {
	return nil
}

func NewReadWriteCounter(io.Reader) ReadWriteCounter {
	return nil
}
